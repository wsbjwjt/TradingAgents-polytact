...
REPORT_AGENTS = [
    ...
    ("policy_report", "政策分析师", "分析师", 14),
    ("hot_money_report", "游资分析师", "分析师", 15),
    ("lockup_report", "解禁分析师", "分析师", 16),
    ("bull_researcher", "多头研究员", "研究", 18),
    ("bear_researcher", "空头研究员", "研究", 19),
    ("research_team_decision", "研究团队（多空辩论）", "研究", 20),
    ("trader_investment_plan", "交易员", "交易", 30),
    ("investment_plan", "投资计划", "交易", 31),
    ("risky_analyst", "激进分析师", "风控", 36),
    ("safe_analyst", "保守分析师", "风控", 37),
    ("neutral_analyst", "中性分析师", "风控", 38),
